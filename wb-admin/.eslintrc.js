module.exports = {
  ...
  rules: {
    ...
    // 禁止使用拖尾逗号，always-multiline：多行模式必须带逗号，单行模式不能带逗号
    ...
    'constructor-super': 2,
    // 强制在点号之前或之后换行，property，'.'号应与属性在同一行
    'dot-location': [2, 'property'],
    // 文件末尾强制换行
    'eol-last': 2,
    // 除了与 null 字面量进行比较时，总是强制使用绝对相等，使用 === 替代 ==
