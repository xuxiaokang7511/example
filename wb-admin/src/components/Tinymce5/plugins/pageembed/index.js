...
!function(t) {
    "use strict";
    var e, n, r, o, i, c, f, a = function(e) {
        ...
        return -1 === function(e, n) {
            ...
            return 0 !== o ? o : 0
        }((r = e) ? s([(t = r).majorVersion, t.minorVersion].join(".").split(".").slice(0, 3).join(".")) : null, s(n));
        var r, t
    }, g = function(e) {
        return function() {
            return e
        }
    }, m = g(!1), p = g(!0), v = m, h = p, b = function() {
        return y
    }, y = (o = {
        fold: function(e, n) {
            return e()
    ...
    }, S = x("string"), T = x("boolean"), A = x("function"), D = x("number"), _ = function(e, n) {
        for (var r = 0, t = e.length; r < t; r++)
            n(e[r], r, e)
    }, C = Array.prototype.push, R = (Array.prototype.slice,
    A(Array.from) && Array.from,
    Object.hasOwnProperty), I = function(e, n) {
        return R.call(e, n)
    }, L = (t.Node.ATTRIBUTE_NODE,
    ...
    function() {
        ...
        detect: function(e, n) {
            ...
            return 0 === e.length ? M() : function(e, n) {
                var r = function(e, n) {
        ...
        firefox: g(U),
        safari: g("Safari")
    }, H = "Windows", V = "Android", X = "Solaris", W = "FreeBSD", G = function(e, n) {
        return function() {
            return n === e
        }
    }, Y = function(e) {
    ...
    }, ee = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, ne = function(n) {
        return function(e) {
            return Z(e, n)
        }
    }, re = [{
        ...
        var n, r, t, o, i, a, u, s, c, f, l, d = oe.browsers(), m = oe.oses(), p = J(d, e).fold(q.unknown, q.nu), v = Q(m, e).fold($.unknown, $.nu);
        return {
            browser: p,
            os: v,
            deviceType: (r = p,
    ...
    function(e) {
        ...
        var r, t, o, i, a;
        ae(e) ? e.dom().classList.add(n) : (function() {
            for (var e = [], n = 0; n < arguments.length; n++)
                e[n] = arguments[n]
        }("element", "offset"),
        o = n,
        a = (void 0 === (i = k(r = e, t = "class")) || "" === i ? [] : i.split(" ")).concat([o]),
        L(r, t, a.join(" ")))
    }, se = function(e, n) {
        return ae(e) && e.dom().classList.contains(n)
    }, ce = "tiny-pageembed", fe = function(e) {
        return se(e, ce)
    }, le = function(e) {
        var n = e.attr("class");
        return n && Z(" " + n + " ", " " + ce + " ")
    }, de = function(a, u, s) {
        return O.from(a).map(E.fromDom).filter(fe).bind(((i = function() {
            var e = t.navigator.userAgent;
            return ie(e)
        }
        ,
        ...
        function(e) {
            ...
            var n, r, t, o, i = function(e, n, r) {
                return O.from(k(e, n)).getOr(r)
            };
            return {
                source: {
                    value: i(e, "src", u.source.value)
                },
                size: (n = a,
                o = E.fromDom(n),
                r = function(e, n) {
                ...
                showBorder: j(e, "frameborder").map(function(e) {
                    return "0" !== e.toLowerCase()
                }).getOr(u.showBorder),
                scrollbar: j(e, "scrolling").map(function(e) {
        ...
        var n, r, t, o, i, a, u, s = (n = e,
        r = E.fromTag("div"),
        L(r, "contentEditable", "false"),
        ue(r, ce),
        "inline" !== n.size && ue(r, n.size),
        r), c = E.fromTag("iframe");
        return pe(c, "src", e.source.value),
        pe(c, "title", e.title),
        pe(c, "name", e.name),
        pe(c, "longdesc", e.descriptionUrl.value),
        (t = e,
        o = "dimensions",
        I(t, o) ? O.some(t[o]) : O.none()).each(function(e) {
            pe(c, "width", e.width),
            pe(c, "height", e.height)
        }),
        ...
        var n = [{
            text: "Inline Value",
            value: "inline"
        }].concat(void 0 !== t.settings.tiny_pageembed_classes ? t.settings.tiny_pageembed_classes : ge)
          , r = function(e) {
            return {
    ...
    return tinymce.PluginManager.add("pageembed", function(e) {
        return d(tinymce, "5.0.0") ? console.error("The pageembed plugin requires at least 5.0.0 of TinyMCE") : ((n = e).on("click keyup", function() {
            O.from(n.selection.getNode()).map(E.fromDom).each(function(e) {
                var n, r;
                fe(e) && (n = "data-mce-selected",
                (r = e.dom()) && r.hasAttribute && r.hasAttribute(n) && L(e, "data-mce-selected", "2"))
            })
        }),
        ...
        (r = e).ui.registry.addToggleButton("pageembed", {
            ...
            onSetup: function(n) {
                var e = function(e) {
                    return n.setActive(!r.readonly && e.element.classList.contains(ce))
                };
