<template>
  <div class="component-preview">
    ...
    <h4>Rate</h4>
    <el-row>
      <el-rate v-model="rate" class="demo-line"></el-rate>
      <el-rate
        v-model="rate"
        class="demo-line"
        show-score
    ...
    <el-row>
      <el-transfer v-model="transfer" filterable :data="transferData">
        <el-button slot="left-footer" class="transfer-footer" size="small">Operation</el-button>
        <el-button slot="right-footer" class="transfer-footer" size="small">Operation</el-button>
      </el-transfer>
    </el-row>
    <h4>Table</h4>
    <el-row>
    ...
    <h4>Loading</h4>
    <el-row>
      <el-table v-loading="true" :data="tableData" style="width: 90%">
        <el-table-column prop="date" label="Date" width="180"></el-table-column>
        <el-table-column prop="name" label="Name" width="180"></el-table-column>
        <el-table-column prop="address" label="Address"></el-table-column>
      </el-table>
    ...
    <el-row>
      ...
      <div
        ...
        style="margin-top: 10px;position: relative; width: 60px;text-align: center;"
      >
        Light
        <div x-arrow class="popper__arrow"></div>
      </div>
    ...
    <el-row>
      ...
      >
        <div class="el-popover__title">Title</div>this is content, this is content, this is content
        <div x-arrow class="popper__arrow"></div>
      </div>
    </el-row>
    <h4>Card</h4>
